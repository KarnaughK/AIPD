...
│       ├── map.md              # 功能线细节图：页面 / 接口 / 数据对象 / 权限 / L3 / L5
│       ├── index.md            # 模块索引
│       └── sop-xxx.md          # 标准流程
...
```text
AGENTS.md -> _adoc/index.md -> _adoc/map.md -> L3/L4/L5 map -> 局部 README / 代码入口
```
...
- `_adoc/L4-product/{feature}/map.md`：面向“这条功能线落在哪些实现入口”，列页面、接口、数据对象、权限码、相关 L3/L5。
- `_adoc/L5-dev/map.md`：面向“这个功能怎么工程化实现”，列跨模块、跨端、跨页面、长期稳定的实现规则和工程约定。
