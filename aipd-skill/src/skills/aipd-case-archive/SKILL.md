...
归档前后如果发现 case / step 中有稳定知识尚未沉淀，应先整理 Weave Candidate，并建议运行 `/aipd-weave` 判断回写到 L3 / L4 / L5 / 局部 README / map。`case-archive` 不内置完整反向编织规则，避免和 `aipd-weave` 形成两套回写判断。
...
告知用户 Case 已完成并合并，推荐执行 `/aipd-case-create` 开始下一个 case。
