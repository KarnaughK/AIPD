...
`aipd2-learn` 吸收的是 AIPD2 框架经验，不是外部项目案例库。诊断、回流包和写回方案中，除来源定位卡、transcript path、项目路径、分支名等必要定位信息外，不要把外部项目的专有名词写入 AIPD2 通用规则。
...
5. **用户纠正 Agent 的逐层确认和落盘保真**
   ...
   - 这类问题优先回写 `aipd2-case-create` 的逐层确认规则、step 模板和 step 上下文隔离规则。
