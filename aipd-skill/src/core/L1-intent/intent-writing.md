...
具体功能放到 `_adoc/L4-product/` 各模块里。

### 4. Intent 的"三不"原则

- ❌ **不描述具体功能**：如"一键验证"是功能，应该说"快速验证"
- ❌ **不描述技术实现**：如"SQLite 存储"是实现，不应出现在 Intent
- ❌ **不描述操作流程**：如"先标记再验证"是流程，应该放到 `_adoc/L4-product/` 各模块
...
- ✅ 这些问题应该在 L4-product / L5-dev 阶段再问
...
参见 `@references/L1-intent/template.md`
