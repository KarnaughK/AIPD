...
|---|---|---|---|---|
| AIPD 方向 / 分层 / 项目认知 | L1 + L3 | `_adoc/L1-intent/intent.md`、`_adoc/index.md`、`_adoc/L3-core/vertical-concept-modules.md`、`_adoc/L3-core/horizontal-capabilities.md` | `src/core/overview.md` | `rg "L3|L4|L5|L6|认知|上下文|纵向|横向|功能能力" src _adoc` |
| 纵向概念模块 / 横向功能能力 / L1-L6 和 map、case、step 的关系 | L3 | `_adoc/L3-core/index.md`、`_adoc/L3-core/vertical-concept-modules.md`、`_adoc/L3-core/horizontal-capabilities.md` | `README.md`、`src/core/overview.md` | `rg "纵向模块|横向功能|Case 系统|Map 检索|L1-L6" _adoc src README.md` |
...
| Weave / 反向编织 / 项目 ADOC 回写 / 更新 map / 更新局部 README | L3 + L5 + case | `_adoc/L3-core/horizontal-capabilities.md`、`_adoc/context-map.md` | `src/skills/aipd2-weave/SKILL.md`、`src/skills/aipd2-case-run/SKILL.md`、`src/skills/aipd2-case-archive/SKILL.md` | `rg "weave|反向编织|Weave Candidate|知识回写|更新 ADOC|更新 map" src _adoc README.md` |
...
| 纵向概念模块 | L1-L6 / OKR / Case / Step / Agent Entry | `_adoc/L3-core/vertical-concept-modules.md` | 不是功能清单；它回答项目认知和代码实现按什么类别沉淀 |
| 横向功能能力 | map 检索 / Case 系统 / Weave 反向编织 / 上下文服务 | `_adoc/L3-core/horizontal-capabilities.md` | 不是新的层级；它回答 Agent 做事时怎么串起纵向模块 |
| Weave 反向编织 | `aipd2-weave` / 项目 ADOC 回写 | `src/skills/aipd2-weave/SKILL.md`、`_adoc/L3-core/horizontal-capabilities.md` | 和 `aipd2-learn` 分工不同；weave 面向当前项目知识库，learn 面向 AIPD2 框架自迭代 |
...
| 反向编织工作流 | 讨论、step、case、diff、错误日志、外部资料回写当前项目 ADOC | `_adoc/L3-core/horizontal-capabilities.md` | `src/skills/aipd2-weave/SKILL.md` |
