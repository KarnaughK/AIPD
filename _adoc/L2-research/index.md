...
L2 不负责解释 AIPD 内部模型细节。Case / Work Package、Weave、SOP、Desktop、Mermaid、Update 等能力的具体设计，分别进入 L3 / L4 / L5 / SOP / case；L2 只回答这些能力背后的需求来源。
...
AIPD 需要用 OKR、Case、Phase、Work Package、执行记录、分身 Agent 和 Weave Candidate，解决 AI 长时间工作和长任务恢复的问题。
...
这条线对应 Case 验收、Work Package 执行记录、Weave Candidate、Close phase、git push 等能力。它解决的不是让 AI 更能干，而是让 AI 做完之后，人能收得住、验得清、信得过。
...
- Case / Work Package 字段、模板和执行机制，进入 L3 / L4 / case 模板。
