# Step: c0.2.2 - 更新 Codex 平台指南和 case-run 派发逻辑
...
让 Codex 平台指南和 case-run skill 使用同源分身模型解释子 Agent 派发，不再把显式上下文传递写成唯一来源。
...
- [x] 更新 case-create 中对子 Agent 调研/草案的描述。
...
- 更新 `src/skills/aipd2-case-create/SKILL.md`，把 case 草案调研描述为同源分身的结果回流。
