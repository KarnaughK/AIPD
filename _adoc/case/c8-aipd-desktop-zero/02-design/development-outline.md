...
> 本文作为 c8 的旧总开发纲要。它不是最终 PRD，也不是立即执行计划；后续若恢复推进，需要按当前 Case / Work Package 语言刷新后再执行。
...
```text
c8/wp-01-project-bootstrap
c8/wp-02-aipd-file-tree-readonly
c8/wp-03-codex-appserver-spike
c8/wp-04-chat-ui-mvp
c8/wp-05-preview-and-context-chips
```
