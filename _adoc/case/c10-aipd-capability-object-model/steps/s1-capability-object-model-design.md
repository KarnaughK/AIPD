...
- `_adoc/case/c10-aipd-capability-object-model/case.md`
- `_adoc/case/c10-aipd-capability-object-model/doc/discussion-seed.md`
- `_adoc/case/archive/c9-aipd-think-system-design/case.md`
- `_adoc/case/archive/c9-aipd-think-system-design/doc/peer-framework-survey.md`
- `_adoc/case/archive/c9-aipd-think-system-design/doc/aipd-boundary-comparison.md`
- `_adoc/case/archive/c9-aipd-think-system-design/doc/think-object-state-design.md`
- `_adoc/case/archive/c9-aipd-think-system-design/doc/handoff-and-skill-boundary.md`
...
- 结果文件路径：`_adoc/case/c10-aipd-capability-object-model/doc/capability-object-model-design.md`
