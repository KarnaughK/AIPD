...
```text
_adoc/case/c10-aipd-capability-object-model/
├── case.md
├── steps/
...
- `_adoc/case/archive/c9-aipd-think-system-design/case.md` - Think 调研设计 case。
- `_adoc/case/archive/c9-aipd-think-system-design/doc/openspec-think-analysis.md` - OpenSpec 机制分析。
- `_adoc/case/archive/c9-aipd-think-system-design/doc/peer-framework-survey.md` - Spec Kit、BMAD、Open SWE、Kiro、Cline 等同类资料调研。
- `_adoc/case/archive/c9-aipd-think-system-design/doc/aipd-boundary-comparison.md` - Inbox / Think / Case / SOP / Weave 边界矩阵。
- `_adoc/case/archive/c9-aipd-think-system-design/doc/think-object-state-design.md` - Think 对象和状态流转设计。
- `_adoc/case/archive/c9-aipd-think-system-design/doc/handoff-and-skill-boundary.md` - Think -> Case Create handoff 和 skill 边界设计。
- `_adoc/case/c10-aipd-capability-object-model/doc/discussion-seed.md` - 本 case 的原始讨论种子。
