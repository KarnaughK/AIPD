# Case: c0.6-human-docs-three-lines
...
```text
_adoc/case/c0.6-human-docs-three-lines/
...
- **Case / 历史 Step**：重点参考 `c0.5-human-docs-architecture`，避免重复发明 docs 体系，只在其基础上升级教学主线。
...
- `_adoc/case/c0.5-human-docs-architecture/case.md` - 旧版 docs 架构 case，确认已完成内容和后续可复用判断。
...
- [x] `steps/c0.6.1-update-human-docs-three-lines.md` - 更新面向人的 docs 学习路径为“三条主线 + 辅助能力”（推荐 Agent：worker）
...
- [ ] Agent 是否先读取 `_adoc/map.md` 和 `c0.5-human-docs-architecture`，避免重复设计已有 docs 架构。
