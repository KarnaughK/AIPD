...
2026-07-15，用户确认 c0.12 规则已在实际使用中运行，目前没有明确问题，同意与 c0.13 一并保留在 `main`。c0.12 代码已通过 PR #3 合入 `main`，merge commit 为 `9558a7105db2d279dc79cbe962ac697ae77fad87`。
...
- c0.12 source commits：`9ae1cec7366d5c4e6af3a62917a7c27bb771c1d1`、`fd381c04e4e5e841dd86f670a976c3e52d053a29`。
...
- 可以安全移动到 `_adoc/case/archive/c0.12-codex-gpt-5-6-sol-adaptation/`。
- c0.13 已独立归档；两个 case 的代码与认知结果均保留在 `main`。
