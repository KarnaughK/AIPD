...
| 上下文解耦 / 黑箱上移 / 扁平化检索 / 记忆存取 / AIPDR | AIPD2 核心认知 | L3 + L5 | `_adoc/L3-core/index.md`、`_adoc/L3-core/horizontal-capabilities.md` | `src/core/overview.md`、`src/core/case/overview.md` | `rg "上下文解耦|黑箱上移|决策杠杆|扁平化检索|记忆|黑箱|Memory Retrieval" src _adoc` |
