...
| 框架自迭代 / transcript / 回流包 | Learn | 本文件 | 不适用 | 不适用 | transcript、回流包、AIPD 源码 | `_adoc/L3-core/horizontal-capabilities.md` | `_adoc/L5-dev/index.md` |
...
| 功能线 | 主要源码入口 | 模板 / 支撑文件 |
|---|---|---|
| AIPD 初始化 | `aipd-skill/src/skills/aipd/SKILL.md` | `aipd-skill/src/core/agent-entry/template.md`、`aipd-skill/src/core/adoc/templates/index.md`、`aipd-skill/src/core/adoc/templates/map.md` |
| AIPD Update | `aipd-skill/src/skills/aipd-update/SKILL.md` | `aipd-skill/src/core/agent-entry/template.md`、`aipd-skill/src/core/adoc/templates/index.md`、`aipd-skill/src/core/adoc/templates/map.md`、`aipd-skill/src/core/case/templates/case.md` |
...
| Learn | `aipd-skill/src/skills/aipd-learn/SKILL.md` | Codex transcript、AIPD 源码 |
| Git Push | `aipd-skill/src/skills/aipd-git-push/SKILL.md` | git 当前状态 |

## 兜底搜索

- `rg "aipd-case-create|aipd-case-run|aipd-weave|aipd-learn|aipd-update" aipd-skill/src _adoc`
