...
| L3 Core | `_adoc/L3-core/` | 核心对象、领域语言、核心流程、数据模型和系统成立方式 | 暂缺 |
| L4 Product | `_adoc/L4-product/` | skill、case、agent init 等产品化边界 | 暂缺 |
| L5 Dev | `_adoc/L5-dev/` | 产品功能到代码实现之间的工程实现逻辑、平台适配、Agent 调度和研发约束 | 初始 |
...
- `_adoc/L5-dev/` 存产品功能到代码实现之间的工程实现规则、跨模块研发规则、工程约束、索引和通用 SOP。
