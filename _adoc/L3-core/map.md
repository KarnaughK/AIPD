...
| 长任务 / case / work package / 恢复 / 验收 | 任务执行模型 | 短周期目标如何通过 Goal / Think / Design / Execute / Verify / Close 变成可恢复、可验收、可关闭的执行闭环 | `_adoc/L3-core/index.md`、`_adoc/L3-core/horizontal-capabilities.md`、`_adoc/case/index.md` | AIPD Case | Case 不是普通聊天记录，Work Package 不是微步骤 |
...
| 上下文解耦 | 任务上下文解耦 | 把任务设计成小而自足的上下文黑箱 | `_adoc/L3-core/index.md`、`aipd-skill/src/core/overview.md` | aipd-case | 不是否定知识库和上下文检索 |
