...
| Case 系统 | 一个短周期目标如何按 Goal / Think / Design / Execute / Verify / Close 完成闭环 | OKR、Case、Work Package、L1-L6、Agent 使用方案 |
...
- Case Goal 解决“这个短周期目标是什么、完成标准是什么、需要哪些上下文”。
...
Case Goal 会横向读取 L1-L6、map、局部 README 和必要的 OKR 约束，把一次事项压缩成可恢复的 case。
