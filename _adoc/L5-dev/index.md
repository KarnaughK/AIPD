...
- `aipd-skill/src/platforms/codex/core/agent-guide.md` 是 Codex 分身 Agent 调度策略的主要来源。
...
- 修改 AIPD2 源码后，Agent 可以直接运行 `./aipd-skill/scripts/build` 作为低风险打包验证；不要默认执行安装脚本。
...
- `aipd-skill/src/core/L5-dev/vue-case-create-guide.md`：Vue 前端 case-create 的前置设计、step 粒度和 Agent 推荐。
