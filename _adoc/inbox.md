...
- 原根目录 `v2-todo/` 已迁移到 `docs/legacy/v2-todo/`。

原始记录：
- `docs/legacy/v2-todo/todo.md` 保留了早期 AIPD2 待讨论事项，包括已有项目刷新机制、Agent 身份后续迭代、降低 AIPD 侵入感、对外定位表述、AIPD 框架上移与 Case-as-Goal。
- `docs/legacy/v2-todo/archive/` 保留了早期已完成事项记录。

待判断：
- `已有项目刷新机制` 是否已经被 `aipd2-update` 覆盖，是否还需要新 case。
