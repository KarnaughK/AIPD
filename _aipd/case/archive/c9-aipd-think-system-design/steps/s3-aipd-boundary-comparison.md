...
- `_adoc/case/archive/c9-aipd-think-system-design/doc/openspec-think-analysis.md`
...
- 结果文件路径：`_adoc/case/archive/c9-aipd-think-system-design/doc/aipd-boundary-comparison.md`
- 格式：边界矩阵 + 典型场景分流 + 误用反例。
...
**主要改动**：
- 新增 `_adoc/case/archive/c9-aipd-think-system-design/doc/aipd-boundary-comparison.md`。
