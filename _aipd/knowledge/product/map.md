...
| AIPD update / 已是 v2 / 更新 AGENTS / 同步新模板 | AIPD Update | 已存在 | `aipd-skill/src/skills/aipd-update/SKILL.md` | `AGENTS.md`、`_aipd/index.md`、`_aipd/map.md`、Case 模板 | 项目知识库维护模型、Map-first 上下文检索模型 | `_aipd/knowledge/engineering/index.md`、`aipd-skill/src/core/workspace/templates/` |
...
| AIPD Update | `aipd-skill/src/skills/aipd-update/SKILL.md` | `aipd-skill/src/core/agent-entry/template.md`、`aipd-skill/src/core/workspace/templates/`、`aipd-skill/src/core/case/templates/` |
...
- `rg "aipd-case|case-create|case-run|case-archive|aipd-weave|aipd-learn|aipd-okr|aipd-update|aipd-inbox|aipd-mermaid" aipd-skill/src _aipd`
