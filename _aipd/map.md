...
| AIPD 历史 / 发展日志 / 长期回顾 / 肿歪审计 / 为什么演变成现在这样 | AIPD 发展日志 | Intent + Core + 历史回顾 | `_aipd/development-log.md`、`_aipd/knowledge/intent/intent.md` | `git log --date=short --reverse` | `rg "发展日志|肿歪|历史|演进|大迭代|每日更新" _aipd README.md docs` |
